...
OnVehicle = function(value)
	...
	local turbo = ent.turbo and ent.turbo.turbo -- renzu_turbo states bag	local ecu_state = ecu
	...
	Citizen.CreateThreadNow(function()
		if not config.enableDegration then return end
			if GlobalState and GlobalState.NoDegradePlate and GlobalState.NoDegradePlate[plate] == 1 then
